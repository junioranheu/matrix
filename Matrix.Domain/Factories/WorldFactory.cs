...
public sealed class WorldFactory()
{
    ...
    public static World Create(DateOnly currentYear)
    {
        ...
        (int manAge, string manLastName) = CreateFirstManOfTheWorld(world, startingCountry, currentYear);

        // Cria a primeira mulher do mundo;
        CreateFirstWomanOfTheWorld(world, startingCountry, currentYear, manAge, manLastName);
